            ...
            <ul className="list-group mb-3">
              {state.map((item) => {
                ...
                return (
                  ...
                  >
                    <NavLink to={`/cart`}>
                      <img className="chekout__item-img" src={item.img} />
                    </NavLink>
                    <span className="checkout__cart-qty">{item.qty}</span>
                    <div className="chekout__item-desc">
              ...
              <div className="row g-3">
                ...
                <div className="col-md-5">
                  ...
                  <select className="form-select" id="country" required="">
                    <option dafaultValue="">Choose...</option>
